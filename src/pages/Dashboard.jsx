...
function Dashboard(props) {
    ...
    return (
        <AppWrapper title="Dashboard">
            <div className='h-full flex dashboard flex-col items-center pt-5'>
                <h2 className='text-5xl font-500'>Welcome Back!</h2>
                <p className='opacity-7 text-center text-xl mt-1 mb-3'>Navigate Side Bar for More Options!</p>
